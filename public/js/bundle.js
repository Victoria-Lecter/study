...
var FooterActions = function () {
	function FooterActions() {
		...
		this.generateActions('getTopCharacterSuccess', 'getTopCharacterFail');
	}
...
var NavbarActions = function () {
	...
	_createClass(NavbarActions, [{
		key: 'findCharacte',
		value: function findCharacte(payload) {
			var _this = this;
...
var CharacterList = function (_React$Component) {
  ...
  _createClass(CharacterList, [{
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _CharacterListStore2.default.unlisten(this.onChnage);
    }
  }, {
    key: 'componentDidUpdate',
    value: function componentDidUpdate(prevProps) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/simon1400/large_react' },
									'Source Code'
								),
